<%@ Page Title="" Language="C#" MasterPageFile="~/SessionCreated/MasterPage.master" AutoEventWireup="true" CodeFile="projectsadmin.aspx.cs" Inherits="projectsadmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
          <a href="FETable.aspx" class="btn btn-primary">First Year</a>
                        ...
                        <a href="BETable.aspx" class="btn btn-warning">Final Year</a><br />

    <a href="projectform.aspx" class="btn btn-warning">Add Your Own Project!</a>
    <a href="projectform.aspx" class="btn btn-warning">Update Project</a>
    <a href="projectform.aspx" class="btn btn-warning">Delete Project</a>
