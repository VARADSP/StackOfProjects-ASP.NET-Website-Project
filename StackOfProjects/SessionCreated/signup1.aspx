<%@ Page Title="" Language="C#" MasterPageFile="~/SessionCreated/MasterPage.master" AutoEventWireup="true" CodeFile="signup1.aspx.cs" Inherits="signup1" %>
...
<div class="form">
        ...
        <div class="form-group">
		    Confirm your Password  <asp:TextBox ID="cpassbox" TextMode="Password" runat="server" BorderStyle="none" style="border-bottom:1px solid #ccc; margin-left:2em !important"></asp:TextBox>
        ...
        <div class="form-group" style="margin-top:1em">
		    <p>Your Qualification</p>  <asp:TextBox ID="userqualify" runat="server" placeholder="Your Achievement" BorderStyle="none" style="padding:20px;border-bottom:1px solid #ccc; margin-left:2em !important"></asp:TextBox>
