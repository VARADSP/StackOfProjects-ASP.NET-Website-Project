<%@ Page Title="" Language="C#" MasterPageFile="~/SessionCreated/MasterPage.master" AutoEventWireup="true" CodeFile="TETable.aspx.cs" Inherits="TETable" %>
...
&nbsp;<!-- /. ROW  --><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="1523px" CellPadding="4" DataKeyNames="projectid" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="399px" AllowPaging="True" AllowSorting="True">
