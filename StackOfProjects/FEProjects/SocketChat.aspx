<%@ Page Language="C#" AutoEventWireup="true"CodeFile="SocketChat.aspx.cs" Inherits="generate_page_runtime.SocketChat" %>
<!DOCTYPE html>
<head>
...
<p>Its a basic socket programming chatting application</p> <p> Technology Used Java</p>
				</div>
			</div>
...
<div id="content"><!-- left hand main content --><div id="page">
		...
		<p>This program is designed in the following technologyJava and the program is designed for the following purpose Its a basic socket programming chatting application 
<pre>
</pre>
 <br /><br /><br /><br /><br />
<asp:Button runat="server" class="downloadbtn" Text="Download Project" onclick="downloadClick"/>
	...
	<div id="sidebar">
		...
		<ul>
			<li><a href="#"><h3>www.github.com</h3></a></li>
