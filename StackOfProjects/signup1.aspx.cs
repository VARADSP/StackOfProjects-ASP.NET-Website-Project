...
public partial class signup1 : System.Web.UI.Page
{
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        String userquali = userqualify.SelectedItem.Value;
     ...
     /*   SqlCommand check_User_Name = new SqlCommand("SELECT * FROM userdata WHERE ([username=@user])",con);
        ...
        */
        ...
        else
        {
            ...
            String que = "Insert into userdata(name,username,pass,cpass,phone,userqual,useraddr,userdesc,userid) values('" + name1 + "','" + username1 + "','" + pass1 + "','" + cpass1 + "','" + phone1 + "','" + userquali + "','" + useraddr + "','" + userdetails + "'," + userid + ")";
