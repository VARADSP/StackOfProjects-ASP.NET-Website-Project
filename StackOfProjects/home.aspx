...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/project-list.png');">
  <div id="pageintro" class="hoc clear"> 
    ...
    <article>
      <div>
        <p class="heading">Welcome TO Stack Of Projects</p>
        <h2 class="heading">PROJECTS LIST</h2>
        <p>We Provide Projects References For People</p>
      </div>
      <footer>
        <ul class="nospace inline pushright">
          <li><a class="btn inverse" href="projects.aspx">View Projects</a></li>
    ...
    <ul class="nospace group cta">
      ...
      <li class="one_third">
        <article><strong class="numb">02</strong>
          <h6 class="heading font-x1"><a href="#">How Can You View Projects? </a></h6><br />
    ...
    <ul class="nospace group services">
      <li class="one_third first btmspace-30">
        <article><a href="#"><i class="fa fa-4x fa-language"></i></a>
          <h6 class="heading font-x1">Different Languages For Projects</h6><br />
      ...
      <li class="one_third btmspace-30">
        <article><a href="#"><i class="fa fa-4x fa-balance-scale"></i></a>
          <h6 class="heading font-x1">Category of Projects We Provide!</h6><br />
      ...
      <li class="one_third btmspace-30">
        <article><a href="#"><i class="fa fa-4x fa-map-signs"></i></a>
          <h6 class="heading font-x1">How to Find Proper Projects For Reference</h6><br />
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="group">
      <article class="one_third" style="margin-left:170px"><a href="#"><img class="btmspace-30" height="50px" width="50px" src="images/makers/vinay.jpg" alt="" style="height:100px;width:100px;"></a>
        <h4 class="heading">Vinay Rathi</h4>
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" height="50" width="50" src="images/makers/varad.jpg" alt="" style="height:100px;width:100px;"></a>
        <h4 class="heading">Varad Parlikar</h4>
        <p class="para2"></p>
        <p class="nospace"><a href="#" class="readmore2">Read More &raquo;</a></p><br />
      </article>
        <article class="one_third" style="margin-left:170px;margin-top:20px"><a href="#"><img class="btmspace-30" style="height:100px;width:100px;" height="50px" width="50px" src="images/makers/sanket.jpg" alt=""></a>
        <h4 class="heading">Sanket Pujari</h4>
        <p class="para3"></p>
        <p class="nospace"><a href="#" class="readmore3">Read More &raquo;</a></p>
      </article>
        <article class="one_third" style="margin-top:20px"><a href="#"><img class="btmspace-30" height="50px" width="50px" style="height:100px;width:100px;" src="images/makers/abhijit.jpg" alt=""></a>
        <h4 class="heading">Abhijit Pedhe</h4>
        <p class="para4"></p>
