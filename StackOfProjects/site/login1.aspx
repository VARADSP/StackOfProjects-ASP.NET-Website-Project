<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="login1.aspx.vb" Inherits="login1" %>
...
<div class="form">
    <table class="style1">
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox1" runat="server" BorderStyle="none" style="border-bottom:1px solid #ccc; margin-left:2em !important;line-height:1em" placeholder="abc@example.com"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="style2">
                <asp:Button ID="Button_Id" runat="server" Text="Login" Width="91px" style="border:1px solid #7526c8;background:#7526c8;color:#fff; padding:5px 19px;float:right" />
            </td>
        </tr>
    </table>
</div>
