<%@ Page Language="C#" AutoEventWireup="true"CodeFile="StudentManagement.aspx.cs" Inherits="generate_page_runtime.StudentManagement" %>
<!DOCTYPE html>
<head>
...
<p>Its a project where I have designed for managing different students report</p> <p> Technology Used C++</p>
				</div>
			</div>
...
<div id="content"><!-- left hand main content --><div id="page">
		...
		<p>This program is designed in the following technologyC++ and the program is designed for the following purpose Its a project where I have designed for managing different students report 
<pre>
</pre>
 <br /><br /><br /><br /><br />
<asp:Button runat="server" class="downloadbtn" Text="Download Project" onclick="downloadClick"/>
	...
	<div id="sidebar">
		...
		<ul class="clientlist">
		<li><a href="#"><h2>Mukesh Pawar</h2></a></li>
			<li><a href="gmail.com?email=muka@gmail.com"><h2>muka@gmail.com</h2></a></li>
			<li><a href="#"></a></li><li><a href="#"></a></li>
		</ul><br class="clear" />
		<h3>Related <strong>websites</strong></h3>
		<ul>
			<li><a href="#"><h3>www.google.com</h3></a></li>
