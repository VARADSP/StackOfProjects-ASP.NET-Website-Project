<%@ Page Language="C#" AutoEventWireup="true"CodeFile="Stores.aspx.cs" Inherits="generate_page_runtime.Stores" %>
<!DOCTYPE html>
<head>
<title>Stores</title>
...
<p>Its a basic store emulation project</p> <p> Technology Used C++</p>
				</div>
			</div>
...
<div id="content"><!-- left hand main content --><div id="page">
		...
		<p>This program is designed in the following technologyC++ and the program is designed for the following purpose Its a basic store emulation project 
<pre>
</pre>
 <br /><br /><br /><br /><br />
<asp:Button runat="server" class="downloadbtn" Text="Download Project" onclick="downloadClick"/>
	...
	<div id="sidebar">
		...
		<ul class="clientlist">
		<li><a href="#"><h2>VSPHACKER</h2></a></li>
