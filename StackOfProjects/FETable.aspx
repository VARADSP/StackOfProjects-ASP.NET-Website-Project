<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FETable.aspx.cs" Inherits="FETable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div class="wrapper row2" style="overflow-x:auto; height: 874px;">
    ...
    <br /><br /><br /><br /><br />
      ...
      <div  style="height:750px; width:1547px;">


          <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" CellPadding="4" Width="1477px" AllowPaging="True" AllowSorting="True" DataKeyNames="projectid" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="399px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
