<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OtherProjects.aspx.cs" Inherits="TETable" %>
...
&nbsp;<!-- /. ROW  --><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="projectid" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="185px" Width="1586px" AllowPaging="True" AllowSorting="True">
