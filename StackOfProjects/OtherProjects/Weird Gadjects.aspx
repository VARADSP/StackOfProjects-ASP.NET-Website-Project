<%@ Page Language="C#" AutoEventWireup="true"CodeFile="Weird Gadjects.aspx.cs" Inherits="generate_page_runtime.Weird Gadjects" %>
<!DOCTYPE html>
<head>
<title>Weird Gadjects</title>
...
<p>These are four gadjects which have different functions.For example one of the gadject performs advanced mathematics.</p> <p> Technology Used C++</p>
				</div>
			</div>
...
<div id="content"><!-- left hand main content --><div id="page">
		...
		<p>This program is designed in the following technologyC++ and the program is designed for the following purpose These are four gadjects which have different functions.For example one of the gadject performs advanced mathematics. 
<pre>
</pre>
 <br /><br /><br /><br /><br />
<asp:Button runat="server" class="downloadbtn" Text="Download Project" onclick="downloadClick"/>
	...
	<div id="sidebar">
		...
		<ul class="clientlist">
		<li><a href="#"><h2>Max Payne</h2></a></li>
			<li><a href="gmail.com?email=maxpayne@gmail.com"><h2>maxpayne@gmail.com</h2></a></li>
