<%@ Page Language="C#" AutoEventWireup="true"CodeFile="BruteForce.aspx.cs" Inherits="generate_page_runtime.BruteForce" %>
<!DOCTYPE html>
<head>
...
<p>Its a algorithm implemented in C++ to detect a particular word in a string quickly.It is very useful for string manipulation.</p> <p> Technology Used C++</p>
				</div>
			</div>
...
<div id="content"><!-- left hand main content --><div id="page">
		...
		<p>This program is designed in the following technologyC++ and the program is designed for the following purpose Its a algorithm implemented in C++ to detect a particular word in a string quickly.It is very useful for string manipulation. 
<pre>
</pre>
 <br /><br /><br /><br /><br />
<asp:Button runat="server" class="downloadbtn" Text="Download Project" onclick="downloadClick"/>
	...
	<div id="sidebar">
		...
		<ul class="clientlist">
		<li><a href="#"><h2>Vishwajeet Deulkar</h2></a></li>
			<li><a href="gmail.com?email=vedjoshi13@gmail.com"><h2>vedjoshi13@gmail.com</h2></a></li>
