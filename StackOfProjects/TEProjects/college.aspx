<%@ Page Language="C#" AutoEventWireup="true" CodeFile="college.aspx.cs" Inherits="TEProjects_college" %>
...
<div id="header">
	...
	<h1><a href="#">College <span>Management</span></a></h1>
		...
		<div id="slides">
			<div>
				...
				<div class="slide-text">
					...
					<p>Its a program for grocery store where you can buy items and it will be added to your basket and total will be given to you</p>
...
<div id="content">
	...
	<div id="page">
		...
		<h2>About The college management</h2>
		<p>Suppose you have to develop a program for managing the all data about patient and other important data of hospital . The following functions have been requested by your Head (The shopkeeper):
 ...
 public class srv1 extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	<div id="sidebar">
		...
		<ul class="clientlist">
			<li><a href="#"><h2>vivek hiwale</h2>
			<li><a href="#"><h2>vivekhiwale92@gmail.com</h2></a></li>
			<li><a href="#"></a></li>
			<li><a href="#"></a></li>
		</ul>
		<br class="clear" />
