<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SETable.aspx.cs" Inherits="SETable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div class="wrapper row2" style="overflow-x:auto; height: 890px;">
    ...
    <br /><br /><br /><br /><br />
               ...
               <div  style="height:751px; width:1615px;">

          <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="projectid" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="410px" Width="1538px" AllowPaging="True" AllowSorting="True">
